...
inline fun <reified T> RestTemplate.postApiResult(path: String, params: Map<String, String> = mapOf()): ApiResult<T>? {
    val response = postForEntity(path, params, String::class.java).body
    val type = typeFactory.constructParametricType(ApiResult::class.java, T::class.java)
    return mapper.readValue(response, type)
}